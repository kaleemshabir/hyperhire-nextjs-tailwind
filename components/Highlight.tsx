export default function Highlight() {
  return (
    <>
      <div className="flex flex-col justify-center items-center mx-auto space-y-4 w-[690px] h-[219px]">
        ...
        <div className=" flex justify-center items-center w-[420px] text-center text-white leading-8 font-pretendard opacity-60">
          여러분이 필요한 영상을 빠르게 제작하기 위해 플루닛 영상제작소가 즉시
          연락 드리겠습니다.
        </div>
      </div>
      <div className=" text-[#666666] mb-14 mt-4 font-pretendard text-[18px] font-normal leading-[21.48px] text-center">
